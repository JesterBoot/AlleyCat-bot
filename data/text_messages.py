...
На каждой точке вам нужно отправить локацию с телефона, для подверждения - отправьте селфи или фото \
велосипеда с объектом на заднем фоне.\n
Для избежания неточностей отправдления локиции с телефона, следует останавливаться и уже после отправлять локацию.\n
