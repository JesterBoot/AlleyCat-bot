'''Уловитель стикеров, теста, и голосовых сообщений.
При приеме стикера - отправляет оди из стикеров из STICKERS,
При приеме голосового - отправляет стикер ne_slishno и сообщение audio_answer
При приеме текста - отправляет сообщение с текстом  из ne_pishi'''
import random
